...
{	
	...
	{
		SSNP_DEBUG_PRINT("create_TBIM():TBC getting TBIM struct failed.\r\n");
		return ERR_VALUE;
	}
	SSNP_DEBUG_PRINT("create_TBIM():TBC getting TBIM struct OK.\r\n");
	SSNP_DEBUG_PRINT("create_TBIM():TBC getting TBIM meta TEDS.\r\n");
	if(get_TBIM_meta_TEDS(t)!=ERR_OK)
		return ERR_VALUE;
	SSNP_DEBUG_PRINT("create_TBIM():TBC getting TBIM meta TEDS OK.\r\n");
	SSNP_DEBUG_PRINT("create_TBIM():TBC getting TBIM tdcn TEDS.\r\n");
	if(get_TBIM_tdcn_TEDS(t)!=ERR_OK)
		return ERR_VALUE;
	SSNP_DEBUG_PRINT("create_TBIM():TBC getting TBIM tdcn TEDS OK.\r\n");
