...
void get_assign_time_slot(u8t tdcn,u16t timeslot_seq,u16t num);//测试用
void set_schedul_table_table(struct schedultable_item* item); //设置调度表项
void test_schedul_table(); //测试用
u8t set_TBIM_Chn_num(void);
